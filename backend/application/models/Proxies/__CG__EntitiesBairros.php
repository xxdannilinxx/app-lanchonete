 ...
 */
class Bairros extends \Entities\Bairros implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Bairros' . "\0" . 'id', '' . "\0" . 'Entities\\Bairros' . "\0" . 'nome', '' . "\0" . 'Entities\\Bairros' . "\0" . 'valor', '' . "\0" . 'Entities\\Bairros' . "\0" . 'situacao', '' . "\0" . 'Entities\\Bairros' . "\0" . 'data'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Bairros $proxy) {
