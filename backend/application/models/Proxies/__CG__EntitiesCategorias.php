 ...
 */
class Categorias extends \Entities\Categorias implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entities\\Categorias' . "\0" . 'id', '' . "\0" . 'Entities\\Categorias' . "\0" . 'nome', '' . "\0" . 'Entities\\Categorias' . "\0" . 'situacao', '' . "\0" . 'Entities\\Categorias' . "\0" . 'data'];
        }
